#!/bin/bash
# update.sh — Обновление Funding-Present через git pull.
# Используй при каждом обновлении кода.
#
# Запуск:
#   chmod +x update.sh
#   ./update.sh
...
# ─── 2. Останавливаем текущие процессы ───────────────────────────────────────
echo ""
echo "▶ Останавливаем старые процессы..."

# Останавливаем по PID-файлам если они есть
...
# Доп. kill на случай если PID-файлы устарели
