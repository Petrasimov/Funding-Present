...
python3 -m pip install --break-system-packages aiohttp asyncpg fastapi uvicorn
...
PGPASSWORD=funding_pass psql -U funding_user -d funding -h 127.0.0.1 -f schema.sql
